...
class MultilingualTranslationTask(LegacyFairseqTask):
    ...
    def _per_lang_pair_train_loss(
        ...
        loss, sample_size, logging_output = criterion(
            model.models[lang_pair], sample[lang_pair], lang_pair
        )
        if ignore_grad:
            loss *= 0
    ...
    def _per_lang_pair_valid_loss(self, lang_pair, model, criterion, sample):
        return criterion(model.models[lang_pair], sample[lang_pair], lang_pair)
    ...
    def inference_step(
        ...
        with torch.no_grad():
            ...
            sample["net_input"]['lang_pair'] = self.lang_pairs[0]
